...
BODY  = 'R:\PRJ-AnimalTech\Day-to-day files\Ongoing analysis DEC 2017_up-to-date the folder\WOW herd\SAS Results WOW_05 02 2018\WoWdata_05 Feb 2018.html'
GPATH = 'R:\PRJ-AnimalTech\Day-to-day files\Ongoing analysis DEC 2017_up-to-date the folder\WOW herd\SAS Results WOW_05 02 2018\';

* database from automatic weighing;
proc import out=df1
datafile='C:\Users\augus\Desktop\github_repositories\databases\mothering up\1_Pye_136_WOW.xlsx'
DBMS = XLSX replace;
*USEDATE=YES;
sheet='SASinput';
getnames=yes;
...
* animal list;
proc import out=df2
datafile='C:\Users\augus\Desktop\github_repositories\databases\mothering up\6_PyeFarm_AnimalList1.xlsx'
DBMS = XLSX replace;
*USEDATE=YES;
sheet='SASinput';
getnames=yes;
...
if missing(EID) or EID='.' then delete;
run;

proc print data=df3 (obs=5);run;
...
proc print data=df3_rawmother (obs=50);run;

*lead animals;
proc sort data=df3_rawmother ;
